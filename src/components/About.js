    ...
    return (
        <div id="about" className="about">
            ...
            <div className="about__text">
                ...
                <p>
                    While remaining <span className="about-text-highlight">enthusiastic</span> about software development, I have, in time, become <span className="about-text-highlight">passionate</span> about frontend technologies, as well as design, UI and UX. In my free time I am an <span className="about-text-highlight">avid</span> musician, manager of the <a href="@Featurefield">@Featurefield</a> blog on instagram, as well as an <span className="about-text-highlight">eager</span> designer.
                </p>
                <p>
